...
const AnimatedInput = ({ label, id, type = "text", register, error, placeholder, optional, ...props }) => {
  return (
    <div className="flex flex-col gap-1.5 w-full mb-5">
      ...
      <div className="relative group">
        <input
          ...
          className={`w-full px-4 py-3 bg-base-100 border-2 rounded-xl focus:outline-none transition-all duration-300 ${
            error 
              ? "border-error/50" 
