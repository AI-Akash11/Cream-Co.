...
export default function RegisterPage() {
  ...
  return (
    <div className="flex flex-col md:flex-row-reverse min-h-[700px]">
      {/* Right Column: Form */}
      <FadeIn className="w-full md:w-1/2 p-8 lg:p-16 flex flex-col justify-center" direction="right">
        <Link
          href="/"
      ...
      {/* Left Column: Banner */}
      <FadeIn className="hidden md:block w-1/2 relative bg-base-300" direction="left">
        <Image
